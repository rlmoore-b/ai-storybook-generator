...
Contains all prompts for the 8 AI judges:

Story Judges (4):
- Safety Judge: Ensures age-appropriate content (ages 5-10)
- Comprehensibility Judge: Checks logic, flow, and clarity
- Writing Quality Judge: Evaluates prose, grammar, and style
- Thematic Judge: Validates moral consistency and character growth

Brainstorm Judges (4):
- Brainstorm Safety Judge: Pre-screens ideas for safety
- Brainstorm Concreteness Judge: Ensures specific, visual concepts
- Brainstorm Uniqueness Judge: Identifies creative, non-cliché ideas
- Brainstorm Sensory Judge: Validates vivid sensory details
...
COMPREHENSIBILITY_JUDGE_PROMPT =  """
...
BRAINSTORM_SAFETY_JUDGE_PROMPT = """
...
BRAINSTORM_CONCRETENESS_JUDGE_PROMPT = """
...
BRAINSTORM_UNIQUENESS_JUDGE_PROMPT = """
...
BRAINSTORM_SENSORY_JUDGE_PROMPT = """
